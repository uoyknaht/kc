<?php
/*
Template Name: Archyvas (industrijos naujienų)
The same as archive_news.php, only query a bit differs
*/
	...
	<div class="page-content">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class('single-article clearfix'); ?>>
			...
			<div class="entry-content">
				...
				<?php smart_archives(array('format' => 'fancy'), array('lang' => pll_current_language('slug'), 'post_type' => 'post', 'new-type' => $staticVars['industryNewTypeSlug'])); ?>
